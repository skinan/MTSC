...
if __name__ == '__main__':
    ...
    # note config
    parser.add_argument('--note', type=str, default='', help='Additional note or experiment description')
    # basic config
    ...
    # SGN
    parser.add_argument(
        "--mlp_ratio", type=int, default=2, help="FFN d_ff / d_model"
    )
    parser.add_argument("--period", type=int, default=32, help="window size of SwinGroupNet")
    parser.add_argument("--num_groups", type=int, default=1, help="groups size of SwinGroupNet")
    parser.add_argument("--block_num", type=int, default=1, help="kernel_size of dataset")
    parser.add_argument(
        "--depths", nargs="+", type=int, default=[6,6,6,6,6,6], help="num block of SwinGroupNet"
    )
    # TimeSWARM
    parser.add_argument(
                "--num_experts",
                type=int,
                default=4,
                help="Number of Inception experts in every MoE layer",
            )
    ...
    parser.add_argument(
                ...
                type=float,
                default=0,
                help="Percentage of Patch Overlapping",
            )
    parser.add_argument(
                "--use_fod",
                type=str2bool,
                default=True,
                help="Use first-order difference together with raw signal"
            )
    ...
    parser.add_argument(
                ...
                type=int,
                default=5,
                help="Kernel size of final channel-time Conv1d mixer"
            )
    ...
    parser.add_argument('--router_top_k', type=int, default=1)
    parser.add_argument('--period_flag', type=int, default=0)
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            batch_change_model_list = ["DuckDuckGeese" , "PEMS-SF", "MotorImagery", "EigenWorms", "InsectWingbeat"]
            if args.model_id in batch_change_model_list:
                args.batch_size = 2
